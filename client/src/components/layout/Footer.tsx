  ...
  return (
    <footer className="bg-[#1a1a1a] text-gray-400 mt-auto pb-20 md:pb-0">
      <div className="max-w-[1200px] mx-auto px-4 py-10 md:py-14">
        <div className="mb-8">
          <h3 className="text-white text-xl font-black tracking-[0.15em] mb-6" style={{ fontFamily: "'Playfair Display', serif" }}>LIKE IT</h3>
          <div className="text-xs leading-relaxed text-gray-500">
            <p>상호명: 라이크잇 | 대표: 홍길동 | 사업자등록번호: 123-45-67890</p>
          </div>
        </div>

        <div className="flex flex-wrap gap-4 md:gap-6 text-xs mb-8">
