              ...
              <div className="w-full border-b border-white/10">
                ...
                {menOpen && (
                  <div className="flex flex-col" style={{ background: "#141414" }}>
                    ...
                    <Link href="/products/clothing?brandName=Chrome+Hearts" onClick={() => setMenuOpen(false)} className="w-full px-7 py-2.5 text-[13px] text-white/70 hover:text-white border-t border-white/5">크롬하츠</Link>
