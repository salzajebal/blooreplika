        ...
        <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-gray-100">
          ...
          <div className="p-6 text-center group hover:bg-gray-50 transition-colors relative">
            ...
            <div className="space-y-4 px-4">
              <div className="flex justify-between items-center border-b border-gray-100 pb-3">
                ...
                <span className="font-bold text-red-600 text-xl tracking-tight">{prices.gold.buyPrice}원</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-sm text-gray-500 font-medium">팔 때</span>
                <span className="font-bold text-blue-600 text-xl tracking-tight">{prices.gold.sellPrice}원</span>
              </div>
            </div>
          ...
          <div className="p-6 text-center group hover:bg-gray-50 transition-colors">
            ...
            <div className="space-y-4 px-4">
              <div className="flex justify-between items-center border-b border-gray-100 pb-3">
                <span className="text-sm text-gray-500 font-medium">살 때 (VAT별도)</span>
                <span className="font-bold text-red-600 text-xl tracking-tight">{prices.silver.buyPrice}원</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-sm text-gray-500 font-medium">팔 때</span>
                <span className="font-bold text-blue-600 text-xl tracking-tight">{prices.silver.sellPrice}원</span>
              </div>
            </div>
          ...
          <div className="p-6 text-center group hover:bg-gray-50 transition-colors">
            ...
            <div className="space-y-4 px-4">
              <div className="flex justify-between items-center border-b border-gray-100 pb-3">
                <span className="text-sm text-gray-500 font-medium">살 때 (VAT별도)</span>
                <span className="font-bold text-red-600 text-xl tracking-tight">{prices.platinum.buyPrice}원</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-sm text-gray-500 font-medium">팔 때</span>
                <span className="font-bold text-blue-600 text-xl tracking-tight">{prices.platinum.sellPrice}원</span>
              </div>
            </div>
