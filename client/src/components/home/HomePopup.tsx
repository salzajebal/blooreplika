...
export function HomePopup() {
  ...
  return (
    <div 
      className="fixed inset-0 z-[100] flex items-center justify-center p-3 sm:p-4 safe-area-inset"
    ...
    >
      ...
      >
        <div 
          ...
          style={{ background: "linear-gradient(135deg, #f59e0b 0%, #eab308 50%, #d97706 100%)" }}
        ></div>
        ...
        <div className="relative pt-4 sm:pt-6 pb-1 sm:pb-2 px-4 sm:px-6 text-center">
          <div 
            className="inline-flex items-center gap-1 sm:gap-1.5 bg-white rounded-full px-3 sm:px-4 py-1 sm:py-1.5 shadow-lg mb-3 sm:mb-4"
            style={{ opacity: 0.95 }}
          >
        ...
        <div className="relative px-4 sm:px-8 pt-2 sm:pt-4 pb-4 sm:pb-8 text-center">
          <div 
            className="w-14 h-14 sm:w-20 sm:h-20 mx-auto mb-4 sm:mb-6 rounded-xl sm:rounded-2xl shadow-xl flex items-center justify-center"
            style={{ background: "linear-gradient(135deg, #facc15 0%, #f59e0b 100%)" }}
          >
            <span className="text-white text-2xl sm:text-3xl" aria-hidden="true">💬</span>
          </div>
          ...
          <div 
            className="rounded-xl sm:rounded-2xl p-3 sm:p-5 mb-3 sm:mb-4 border border-amber-100"
            style={{ background: "linear-gradient(90deg, #fffbeb 0%, #fef9c3 100%)" }}
          >
          ...
          <div 
            className="rounded-xl sm:rounded-2xl p-3 sm:p-4 mb-4 sm:mb-6 border border-red-200"
            style={{ background: "linear-gradient(90deg, #fef2f2 0%, #fff7ed 100%)" }}
          >
          ...
          <div className="flex items-center justify-center gap-2 bg-gray-100 rounded-lg sm:rounded-xl px-3 sm:px-4 py-2 sm:py-3 mb-4 sm:mb-6">
            <div 
              ...
              style={{ background: "linear-gradient(90deg, #facc15 0%, #eab308 100%)" }}
            >
              <span className="text-black text-xs sm:text-sm" aria-hidden="true">💬</span>
            </div>
          ...
          <Button
            onClick={handleClose}
            className="w-full bg-gray-800 hover:bg-gray-900 text-white font-semibold py-4 sm:py-6 rounded-lg sm:rounded-xl shadow-lg text-sm sm:text-base touch-manipulation"
