...
export default function ProductList() {
  ...
  const categoryInfo = CATEGORIES.find(c => c.id === categoryId) || { name: "전체 상품 목록", description: "한국공인금거래소가 보증하는 최고의 품질" };
      ...
      <main className="container-custom py-12">
        ...
        {filteredProducts.length > 0 ? (
          ...
          <div className="py-20 text-center bg-gray-50 border border-dashed border-gray-200 rounded-lg">
            ...
            <Button variant="outline" className="mt-4" onClick={() => window.history.back()}>돌아가기</Button>
          </div>
        )}
      </main>
