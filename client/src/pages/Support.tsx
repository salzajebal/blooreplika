...
const DEFAULT_FAQS = [
  ...
  { id: "3", category: "buy", question: "금 매입 절차가 어떻게 되나요?", answer: "매장 방문 시 금 제품의 순도와 중량을 측정하여 당일 매입 시세로 매입해 드립니다. 신분증을 지참해 주세요." },
  { id: "4", category: "buy", question: "직접 방문하지 못할 경우 어떻게 하나요?", answer: "안전한 택배 매입 서비스를 이용하실 수 있습니다. 자세한 사항은 고객센터로 문의해 주세요." },
    ...
    <div className="min-h-screen bg-white font-sans">
      ...
      <main className="container-custom py-12">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-500">한국공인금거래소에 대해 궁금한 점을 확인하세요</p>
        </div>
