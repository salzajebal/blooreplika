      ...
      <main>
        ...
        <div className="max-w-[1200px] mx-auto px-4 py-8">
          ...
          <div className="text-center mb-12">
            <h2 className="text-2xl font-bold text-gray-900 mb-8">PLIKI 소개</h2>
          ...
          <div className="max-w-3xl mx-auto text-left">
            ...
            <div className="mb-8">
              <h3 className="text-xl font-bold text-gray-800 mb-6">PLIKI의 차별점</h3>
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <ul className="space-y-1 text-gray-700 ml-4">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="text-black font-bold">●</span>
                      <span>PLIKI은 <strong>과장 없는 정직한 정보만 제공</strong></span>
                    </li>
                  </ul>
                </div>
            ...
            <div className="mb-8">
              ...
              <div>
                ...
                <ul className="space-y-1 text-gray-700 ml-4">
                  <li className="flex items-start gap-2">
                    <span className="text-black font-bold">●</span>
                    <span><strong>PLIKI은 "직접 착용할 수 있는 제품"만을 제공</strong></span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-black font-bold">●</span>
            ...
            <div className="text-center mt-12 mb-8">
              ...
              <p className="text-lg font-medium text-gray-900">
                신뢰할 수 있는 레플리카 브랜드를 찾고 있다면, 구글에 PLIKI을 검색해보세요.
              </p>
            </div>
          </div>
        </div>
