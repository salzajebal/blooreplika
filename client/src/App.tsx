...
function Router() {
  return (
    <Switch>
      ...
      <Route path="/products/jewelry">{() => { const [,nav]=useLocation(); React.useEffect(()=>nav("/products/accessories"),[nav]); return null; }}</Route>
      <Route path="/products/belts">{() => { const [,nav]=useLocation(); React.useEffect(()=>nav("/products/accessories"),[nav]); return null; }}</Route>
      <Route path="/products/sunglasses">{() => { const [,nav]=useLocation(); React.useEffect(()=>nav("/products/accessories"),[nav]); return null; }}</Route>
