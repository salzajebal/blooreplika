...
- Quick Menu Items: Admin-managed circular icon shortcuts on homepage (name, image upload, link URL, sort order, active toggle). Images stored in Object Storage (/objects/…). Falls back to default hardcoded items when DB is empty.
